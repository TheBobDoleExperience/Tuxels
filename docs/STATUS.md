...
| S1 — Place image (`File → Place…`) | ⬜ pending | Menu entry + Ctrl+Shift+P; load PNG, `addPixelLayer` centered at doc midpoint, wrapped in `AddLayerCommand`; oversized PNGs keep offscreen pixels via S0 origin plumbing |
