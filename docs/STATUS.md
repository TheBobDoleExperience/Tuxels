...
| S2 — Move tool | ⬜ pending | V shortcut; `MoveLayerCommand(beforeOrigin, afterOrigin)` swap; canvas paints with live-offset preview while dragging |
